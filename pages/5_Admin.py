...
with tab_tmpl:
    ...
    def _load_all_tests_admin():
        ...
        modules = [
            ...
            "tests.visa_a","tests.visa_p",
            "tests.visa_h","tests.visa_g",
            "tests.cait","tests.tegner",
            "tests.dhi","tests.hit6",
            "tests.nrs",
            "tests.borg_rpe","tests.sgrq","tests.lcadl",
            "tests.pcfs","tests.psqi","tests.abc_scale",
            "tests.mini_bestest","tests.fes_i",
            "tests.barthel","tests.ten_mwt","tests.ashworth",
            "tests.iciq_ui","tests.pfdi20",
            "tests.pcs","tests.phq9","tests.gad7",
            "tests.isi","tests.haq","tests.basdai",
            "tests.frailty_scale","tests.frail_scale",
            "tests.gait_speed","tests.k_ses",
            "tests.prwe","tests.bpi",
        ]
        for m in modules:

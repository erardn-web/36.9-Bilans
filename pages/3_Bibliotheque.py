...
def _load_all():
    ...
    modules = [
        ...
        "tests.questionnaires.visa_a","tests.questionnaires.visa_p","tests.questionnaires.visa_h",
        "tests.questionnaires.visa_g","tests.questionnaires.cait","tests.questionnaires.tegner",
        "tests.questionnaires.dhi","tests.questionnaires.hit6","tests.tests_cliniques.nrs",
        ...
        "tests.questionnaires.mini_bestest","tests.questionnaires.fes_i","tests.questionnaires.barthel",
        "tests.questionnaires.ten_mwt","tests.questionnaires.ashworth","tests.questionnaires.iciq_ui",
        "tests.questionnaires.pfdi20","tests.questionnaires.pcs","tests.questionnaires.phq9",
        "tests.questionnaires.gad7","tests.questionnaires.isi","tests.questionnaires.haq",
        "tests.questionnaires.basdai","tests.questionnaires.frailty_scale","tests.questionnaires.frail_scale",
        "tests.questionnaires.gait_speed","tests.questionnaires.k_ses","tests.questionnaires.prwe",

...
def _make_evolution_charts(bilans_df, n_bilans, page_w, excluded_test_ids=None,
    ...
    _TID_TO_PFX_CH = {
        ...
        "dn4":            ["dn4_score"],
        "faos":           ["faos_pain","faos_adl","faos_sport"],
        "kujala":         ["kujala_score"],
        ...
        "visa_g":         ["visa_g_score"],
        "cait":           ["cait_score"],
        "tegner":         ["tegner_actuel"],
        "dhi":            ["dhi_score"],
        "hit6":           ["hit6_score"],
        "hagos":          ["hagos_pain","hagos_adl","hagos_sport"],
        "ikdc":           ["ikdc_score"],
        "csi":            ["csi_score"],
        "qbpds":          ["qbpds_score"],
        "atrs":           ["atrs_score"],
        "wosi":           ["wosi_pct"],
        "borg_rpe":       ["borg_dyspnee_effort","borg_fatigue_effort"],
        "sgrq":           ["sgrq_total"],
        "lcadl":          ["lcadl_score"],
        "pcfs":           ["pcfs_grade"],
        "psqi":           ["psqi_total"],
        "abc_scale":      ["abc_score"],
        "mini_bestest":   ["mini_bestest_score"],
        "fes_i":          ["fes_i_score"],
        "barthel":        ["barthel_score"],
        "ten_mwt":        ["ten_mwt_confort_vitesse"],
        "iciq_ui":        ["iciq_score"],
        "pfdi20":         ["pfdi_total"],
        "pcs":            ["pcs_total"],
        "phq9":           ["phq9_score"],
        ...
        "haq":            ["haq_score"],
        "basdai":         ["basdai_score"],
        "frailty_scale":  ["frailty_grade"],
        "frail_scale":    ["frail_score"],
        "gait_speed":     ["gait_vitesse"],
        "k_ses":          ["kses_total"],
        "prwe":           ["prwe_total"],
        "bpi":            ["bpi_severity_score"],
    }
    def _chart_tid(col):
...
def generate_pdf_generic(bilans_df, patient_info: dict,
    ...
    _TID_TO_COL_PREFIXES = {
        ...
        "psqi":           ["psqi_"],
        "abc_scale":      ["abc_"],
        "mini_bestest":   ["mb_","mini_bestest_"],
        "fes_i":          ["fes_"],
        "barthel":        ["barthel_"],
        "ten_mwt":        ["ten_mwt_"],
        "ashworth":       ["ash_"],
    ...
    if not active_cols:
        ...
        _TESTS = [
            ...
            ("Constant-Murley",      ["cm_score_total","cm_douleur"]),
            ("PRTEE",                ["prtee_total","prtee_pain","prtee_func"]),
            ("BCTQ",                 ["bctq_sss","bctq_fss"]),
            ("Roland-Morris",        ["rmq_score"]),
            ("STarT Back",           ["sb_total","sb_risque"]),
            ("FABQ",                 ["fabq_pa_score","fabq_work_score"]),
            ("DN4",                  ["dn4_score"]),
            ("FAOS",                 ["faos_pain","faos_adl","faos_sport","faos_qol"]),
            ("Kujala AKPS",          ["kujala_score"]),
            ("ACL-RSI",              ["acl_rsi_score"]),
            ("VISA-A",               ["visa_a_score"]),
            ("VISA-P",               ["visa_p_score"]),
            ("VISA-H",               ["visa_h_score"]),
            ("VISA-G",               ["visa_g_score"]),
            ...
            ("ATRS",                 ["atrs_score"]),
            ("WOSI",                 ["wosi_pct"]),
            ("Borg RPE",             ["borg_dyspnee_effort","borg_fatigue_effort"]),
            ("SGRQ",                 ["sgrq_total","sgrq_symptomes","sgrq_activite","sgrq_impact"]),
            ("LCADL",                ["lcadl_score"]),
            ("PCFS",                 ["pcfs_grade"]),
            ("PSQI",                 ["psqi_total"]),
            ("ABC Scale",            ["abc_score"]),
            ("Mini-BESTest",         ["mini_bestest_score"]),
            ("FES-I",                ["fes_i_score"]),
            ("Barthel",              ["barthel_score"]),
            ("10MWT",                ["ten_mwt_confort_vitesse","ten_mwt_max_vitesse"]),
            ("ICIQ-UI",              ["iciq_score"]),
            ("PFDI-20",              ["pfdi_total","pfdi_udi","pfdi_popdi","pfdi_cradi"]),
            ("PCS",                  ["pcs_total","pcs_rumination","pcs_amplification"]),
            ("PHQ-9",                ["phq9_score"]),
            ("GAD-7",                ["gad7_score"]),
            ("ISI",                  ["isi_score"]),
            ("HAQ",                  ["haq_score"]),
            ("BASDAI",               ["basdai_score"]),
            ("Clinical Frailty",     ["frailty_grade"]),
            ("FRAIL Scale",          ["frail_score"]),
            ("Vitesse marche 4m",    ["gait_vitesse"]),
            ("K-SES",                ["kses_total"]),
            ("PRWE",                 ["prwe_total"]),
            ("BPI",                  ["bpi_severity_score","bpi_interference_score"]),
        ]

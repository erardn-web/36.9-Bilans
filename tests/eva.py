...
class EVA(BaseTest):
    ...
    def render_evolution(cls, bilans_df, labels,
        ...
        if show_print_controls:
            _key = cls._print_chart_key('eva', cas_id)
            cls._render_print_checkbox(_key)
            cls._store_chart(_key, fig, cas_id)
        table_rows = [
            {"label": "Repos", "col_key": "s_eva_repos",
             "values": [r.get("s_eva_repos","—") for _,r in bilans_df.iterrows()]},
            {"label": "Mouvement", "col_key": "s_eva_mouvement",
             "values": [r.get("s_eva_mouvement","—") for _,r in bilans_df.iterrows()]},
            {"label": "Nuit", "col_key": "s_eva_nuit",
             "values": [r.get("s_eva_nuit","—") for _,r in bilans_df.iterrows()]},
        ]
        if show_print_controls:

...
class KOOS(BaseTest):
    ...
    def render_evolution(cls, bilans_df, labels,
        ...
        if show_print_controls:
            _key = cls._print_chart_key('koos', cas_id)
            cls._render_print_checkbox(_key)
            cls._store_chart(_key, fig, cas_id)
        table_rows = [
            {"label": "Douleur", "col_key": "koos_pain",
             "values": [r.get("koos_pain","—") for _,r in bilans_df.iterrows()]},
            {"label": "AVQ", "col_key": "koos_adl",
             "values": [r.get("koos_adl","—") for _,r in bilans_df.iterrows()]},
            {"label": "Sport", "col_key": "koos_sport",
             "values": [r.get("koos_sport","—") for _,r in bilans_df.iterrows()]},
            {"label": "QoL", "col_key": "koos_qol",
             "values": [r.get("koos_qol","—") for _,r in bilans_df.iterrows()]},
        ]
        if show_print_controls:

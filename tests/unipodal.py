...
class Unipodal(BaseTest):
    ...
    def render_evolution(cls, bilans_df, labels,
        ...
        if show_print_controls:
            _key = cls._print_chart_key('unipodal', cas_id)
            cls._render_print_checkbox(_key)
            cls._store_chart(_key, fig, cas_id)
        table_rows = [
            {"label": "D ouvert", "col_key": "unipodal_d_ouvert",
             "values": [r.get("unipodal_d_ouvert","—") for _,r in bilans_df.iterrows()]},
            {"label": "G ouvert", "col_key": "unipodal_g_ouvert",
             "values": [r.get("unipodal_g_ouvert","—") for _,r in bilans_df.iterrows()]},
            {"label": "D fermé", "col_key": "unipodal_d_ferme",
             "values": [r.get("unipodal_d_ferme","—") for _,r in bilans_df.iterrows()]},
            {"label": "G fermé", "col_key": "unipodal_g_ferme",
             "values": [r.get("unipodal_g_ferme","—") for _,r in bilans_df.iterrows()]},
        ]
        if show_print_controls:
